...
public class frmPrincipal extends javax.swing.JDialog {
    ...
    private void initComponents()
    {
        ...
        jTabbedPane1.addTab("Fatorial", jTabbedPane2);
        jTabbedPane1.addTab("Primo", jTabbedPane3);
        jTabbedPane1.addTab("Calculadora", jTabbedPane4);
        jTabbedPane1.addTab("Triângulos", jTabbedPane5);

        mnuExercicios.setText("Exercicios");
        ...
        mnuExercicios.add(mniTriangulos);
    ...
    {//GEN-HEADEREND:event_mniTriangulosActionPerformed
        Triangulos triangulo = new Triangulos(null,true);
